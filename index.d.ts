...
export function assertTime(fut: AsyncFut, deadline: number, onSlow: Callback, onTime: Callback | undefined): void;

export function assertTime(fut: SyncFut, deadline: number): number;
export function assertTime(fut: SyncFut, deadline: number, onSlow: Callback, onTime: Callback | undefined): void;
